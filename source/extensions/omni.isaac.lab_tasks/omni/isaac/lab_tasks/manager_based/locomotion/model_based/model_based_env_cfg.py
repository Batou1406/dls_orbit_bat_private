...
class RewardsCfg:
    ...
    # penalty_constraint_violation = RewTerm(func=mdp.penalize_constraint_violation,    weight=-0.001)
    penalty_sampling_rollout     = RewTerm(func=mdp.penalize_sampling_controller_cost,weight=-1e-7)
