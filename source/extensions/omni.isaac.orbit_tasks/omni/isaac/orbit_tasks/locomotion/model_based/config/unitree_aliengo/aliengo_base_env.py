...
class UnitreeAliengoBaseEnvCfg(LocomotionModelBasedEnvCfg):
    def __post_init__(self):
        ...
        self.events.add_base_mass.params["mass_range"] = (-1.0, 3.0)                                                    # Default was ±5
        self.events.add_base_mass.params["asset_cfg"].body_names = "base"                                               # Unnecessary : already default 
        ...
        self.events.base_external_force_torque.params["asset_cfg"].body_names = "base"                                  # Unnecessary : already default 
