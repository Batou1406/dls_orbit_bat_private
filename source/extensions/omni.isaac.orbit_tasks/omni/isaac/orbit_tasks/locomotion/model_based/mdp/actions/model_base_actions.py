...
class ModelBaseAction(ActionTerm):
    ...
    * Applying actions: This operation is performed once per **simulation step** and is
    ...
    def process_actions(self, actions: torch.Tensor):
        ...
        self.f = (self._processed_actions[:, :self._num_legs]).clamp(0.5,10) # 0:3 and clip frequency to valid range [0,20]
        self.d = (self._processed_actions[:, self._num_legs:2*self._num_legs]).clamp(0.15,0.85) # 4:7 and clip leg duty cycle to valid range [0,1]
